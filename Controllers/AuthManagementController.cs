    ...
    public class AuthManagementController : ControllerBase
    {
        ...
        private async Task<AuthResult> VerifyAndGenerateToken(TokenRequest tokenRequest)
        {
            ...
            try
            {
                ...
                var expiryDate = UnixTimeStampDoDateTime(utcExpiryDate);
                ...
                //validation 6 - validate if its revorked
        ...
        private DateTime UnixTimeStampDoDateTime(long unixTimeStamp)
        {
        ...
        private async Task<AuthResult> GenerateJwtToken(IdentityUser user)
        {
            ...
            var tokenDescriptor = new SecurityTokenDescriptor
            {
                ...
                Expires = DateTime.UtcNow.AddSeconds(30), // 5-10 minutes in nofrmal conditions
        ...
        private string RandomString(int length)
        {
            ...
            var chars = "ABCDJJJDJID()DJSAIOJDOIJ";
